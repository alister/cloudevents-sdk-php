...
LABEL org.opencontainers.image.url="https://github.com/cloudevents/sdk-php/tree/main/hack/7.3.Dockerfile" \
      ...
      org.opencontainers.image.title="PHP 7.3" \
      org.opencontainers.image.description="PHP 7.3 test environment for cloudevents/sdk-php"
